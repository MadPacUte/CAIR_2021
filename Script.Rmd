...
# Create another dataset to show the proportion of sex/ethnicity based on PERIOD
# Create a new column that will break up the PERIOD column into the respective years
...
```{r}
# code to replace all columns that are na with 0 
replace(., is.na(.), 0)
